    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <img
          ...
          className={`w-full h-64 object-cover transition-all duration-700 group-hover:scale-115 ${
      ...
      <div className="p-5 relative z-10">
            ...
            {[...Array(5)].map((_, i) => (
              <FaStar
                ...
                className={`text-sm transition-all duration-300 ${
                  i < Math.floor(rating) ? 'text-yellow-400 drop-shadow-[0_0_3px_rgba(250,204,21,0.5)]' : 'text-gray-600'
                }`}
                style={{
        ...
        <button
          ...
          className={`w-full py-3.5 rounded-xl font-semibold transition-all duration-400 flex items-center justify-center gap-2 relative overflow-hidden ${
            isAddingToCart
